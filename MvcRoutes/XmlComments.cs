...
namespace MvcRoutes
{
    public class XmlComments
    {
        ...
        private static readonly Hashtable _assemblyDocs = new Hashtable();
        ...
        /// </summary>
        private static readonly Hashtable _typeAccessors = new Hashtable();
        ...
        {
            if (mi == null)
                throw new ArgumentNullException("mi", "A MemberInfo must be supplied in order to retrieve the comments.");
